...
var dataSources = {danceability: cliff, energy:cliff, speechiness:cliff, liveness: random, acousticness:random, valence:random};
...
function selectDataSource(tid,owid) {
  ...
  .then(function(data) {
	...
	$('#selectPlaylist').fadeOut(aSpeed, function() {
		...
		//var attributes = {danceability: .5, energy:.5, speechiness:.5, liveness: .5, acousticness:.5, valence:.5};
      smoothiedanceability = new SmoothieChart({ labels:{disabled:true}, millisPerPixel: 100,maxValue:1,minValue:0,grid: { strokeStyle: 'rgb(51, 51, 51)', fillStyle: 'rgb(51,51,51)', lineWidth: 1, verticalSections: 25} });
      smoothieenergy  = new SmoothieChart({ labels:{disabled:true}, millisPerPixel: 100,maxValue:1,minValue:0,grid: { strokeStyle: 'rgb(51, 51, 51)', fillStyle: 'rgb(51,51,51)', lineWidth: 1, verticalSections: 25} });
        smoothiespeechiness  = new SmoothieChart({ labels:{disabled:true}, millisPerPixel: 100,maxValue:1,minValue:0,grid: { strokeStyle: 'rgb(51, 51, 51)', fillStyle: 'rgb(51,51,51)', lineWidth: 1, verticalSections: 25} });
        smoothieliveness = new SmoothieChart({ labels:{disabled:true}, millisPerPixel: 100,maxValue:1,minValue:0,grid: { strokeStyle: 'rgb(51, 51, 51)', fillStyle: 'rgb(51,51,51)', lineWidth: 1, verticalSections: 25} });
        smoothieacousticness  = new SmoothieChart({ labels:{disabled:true}, millisPerPixel: 100,maxValue:1,minValue:0,grid: { strokeStyle: 'rgb(51, 51, 51)', fillStyle: 'rgb(51,51,51)', lineWidth: 1, verticalSections: 25} });
        smoothievalence  = new SmoothieChart({ labels:{disabled:true}, millisPerPixel: 100,maxValue:1,minValue:0,grid: { strokeStyle: 'rgb(51, 51, 51)', fillStyle: 'rgb(51,51,51)', lineWidth: 1, verticalSections: 25} });
    
		smoothiedanceability.addTimeSeries(danceabilityTS, { strokeStyle: 'rgb(255, 255, 255)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 3 });
		smoothiedanceability.streamTo(document.getElementById("danceabilityCanvas"), 1000);
       
       
    
		smoothieenergy.addTimeSeries(energyTS, { strokeStyle: 'rgb(255, 255, 255)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 3 });
		smoothieenergy.streamTo(document.getElementById("energyCanvas"), 1000);
		
    
		smoothiespeechiness.addTimeSeries(speechinessTS, { strokeStyle: 'rgb(255, 255, 255)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 3 });
		smoothiespeechiness.streamTo(document.getElementById("speechinessCanvas"), 1000);
		
    
		smoothieliveness.addTimeSeries(livenessTS, { strokeStyle: 'rgb(255, 255, 255)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 3 });
		smoothieliveness.streamTo(document.getElementById("livenessCanvas"), 1000);
		
    
		smoothieacousticness.addTimeSeries(acousticnessTS, { strokeStyle: 'rgb(255, 255, 255)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 3 });
		smoothieacousticness.streamTo(document.getElementById("acousticnessCanvas"), 1000);
		
    
		smoothievalence.addTimeSeries(valenceTS, { strokeStyle: 'rgb(255, 255, 255)', fillStyle: 'rgba(0, 255, 0, 0)', lineWidth: 3 });
